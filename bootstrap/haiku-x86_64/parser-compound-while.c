...
void CWHILESTMTEND( void )
{
	...
	label$20:;
	LEXSKIPTOKEN( 2048ll );
	if( *(struct $7ASTNODE**)((uint8*)STK$1 + 16ll) == (struct $7ASTNODE*)0ull) goto label$23;
	{
		ASTSCOPEEND( *(struct $7ASTNODE**)((uint8*)STK$1 + 16ll) );
	}
	label$23:;
	label$22:;
	struct $7ASTNODE* vr$5 = ASTNEWBRANCH( 99ll, *(struct $8FBSYMBOL**)((uint8*)STK$1 + 24ll), (struct $7ASTNODE*)0ull );
	ASTADD( vr$5 );
