...
struct $7ASTNODE* CVAFUNCT( void )
{
	...
	label$73:;
	{
		...
		label$78:;
		{
			...
			EXPR$3 = vr$9;
			struct $7ASTNODE* vr$10 = ASTNEWCONV( 32ll, (struct $8FBSYMBOL*)0ull, EXPR$3, 0ll, (int64*)0ull );
			EXPR$3 = vr$10;
			struct $7ASTNODE* vr$12 = ASTNEWCONSTI( *(int64*)((uint8*)VARARG_PARAM$1 + 80ll), 9ll, (struct $8FBSYMBOL*)0ull );
			struct $7ASTNODE* vr$13 = ASTNEWBOP( 28ll, EXPR$3, vr$12, (struct $8FBSYMBOL*)0ull, 8ll );
			fb$result$1 = vr$13;
		}
		label$81:;
		label$77:;
...
struct $7ASTNODE* CVALISTFUNCT( $8FB_TOKEN TK$1 )
{
	...
	label$95:;
	{
		...
		LGT$2 = ((vr$27 + *(int64*)((uint8*)&ENV$ + 616ll)) + -1ll) & -(*(int64*)((uint8*)&ENV$ + 616ll));
	...
	struct $8FBSYMBOL* VARARG_SYM$1;
	{
		...
		label$126:;
		{
			...
			if( vr$43 <= 1ll) goto label$138;
			{
				...
				struct $7ASTNODE* vr$46 = ASTNEWMACRO( 112ll, EXPR1$1, EXPR2$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
				ASTADD( vr$46 );
			}
			goto label$137;
			label$138:;
...
static struct $7ASTNODE* HCHECKLASTPARAMETERSYMBOL( struct $7ASTNODE* EXPR$1, struct $8FBSYMBOL* VARARG_PARAM$1, struct $8FBSYMBOL* VARARG_SYM$1 )
{
	...
	ERRREPORTEX( 14ll, (char*)*(char**)((uint8*)VARARG_PARAM$1 + 32ll), 0ll, 1ll, (char*)0ull );
	ASTDELTREE( EXPR$1 );
