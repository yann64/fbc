...
void CDOSTMTBEGIN( void )
{
	...
	LEXSKIPTOKEN( 2048ll );
	struct $8FBSYMBOL* vr$0 = SYMBADDLABEL( (char*)0ull, 4ll );
	IL$1 = vr$0;
	struct $8FBSYMBOL* vr$1 = SYMBADDLABEL( (char*)0ull, 0ll );
	EL$1 = vr$1;
	...
	ISUNTIL$1 = 0ll;
	{
		...
		TMP$95$2 = vr$3;
		if( TMP$95$2 != 273ll) goto label$13;
		label$14:;
		{
			ISWHILE$1 = -1ll;
		}
		goto label$12;
		label$13:;
		if( TMP$95$2 != 274ll) goto label$15;
		label$16:;
		{
			ISUNTIL$1 = -1ll;
		}
...
void CDOSTMTEND( void )
{
	...
	ISUNTIL$1 = 0ll;
	{
		...
		TMP$96$2 = vr$1;
		if( TMP$96$2 != 273ll) goto label$28;
		label$29:;
		{
			ISWHILE$1 = -1ll;
		}
		goto label$27;
		label$28:;
		if( TMP$96$2 != 274ll) goto label$30;
		label$31:;
		{
			ISUNTIL$1 = -1ll;
		}
	...
	label$39:;
	{
		struct $7ASTNODE* vr$18 = ASTNEWBRANCH( 99ll, *(struct $8FBSYMBOL**)((uint8*)STK$1 + 32ll), (struct $7ASTNODE*)0ull );
		ASTADD( vr$18 );
	}
	label$38:;
