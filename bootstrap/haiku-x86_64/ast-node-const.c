...
int64 ASTCONSTEQZERO( struct $7ASTNODE* N$1 )
{
	...
	label$15:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$85$1 * 56ll)) != 1ll) goto label$14;
	{
...
int64 ASTCONSTGEZERO( struct $7ASTNODE* N$1 )
{
	...
	label$23:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$86$1 * 56ll)) != 1ll) goto label$20;
	{
		fb$result$1 = (int64)-(*(double*)((uint8*)N$1 + 40ll) >= 0x0p+0);
	}
	goto label$19;
	...
	goto label$24;
	label$22:;
	TMP$87$1 = *(int64*)((uint8*)N$1 + 8ll) & 31ll;
	label$24:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$87$1 * 56ll)) + 16ll) == 0ll) goto label$21;
	{
		fb$result$1 = (int64)-(*(int64*)((uint8*)N$1 + 40ll) >= 0ll);
	}
	goto label$19;
...
struct $7ASTNODE* ASTNEWCONSTSTR( char* V$1 )
{
...
struct $7ASTNODE* ASTNEWCONSTI( int64 VALUE$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	*(int64*)((uint8*)N$1 + 48ll) = 0ll;
	struct $7ASTNODE* vr$4 = ASTNEWCONV( DTYPE$1, SUBTYPE$1, N$1, 8ll, (int64*)0ull );
	N$1 = vr$4;
	fb$result$1 = N$1;
	label$40:;
	return fb$result$1;
...
struct $7ASTNODE* ASTNEWCONSTF( double VALUE$1, int64 DTYPE$1 )
{
	...
	*(int64*)((uint8*)N$1 + 48ll) = 0ll;
	struct $7ASTNODE* vr$4 = ASTNEWCONV( DTYPE$1, (struct $8FBSYMBOL*)0ull, N$1, 0ll, (int64*)0ull );
	fb$result$1 = vr$4;
	label$42:;
	return fb$result$1;
}
...
struct $7ASTNODE* ASTNEWCONST( union $7FBVALUE* V$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$48:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$88$1 * 56ll)) != 1ll) goto label$47;
	{
...
struct $7ASTNODE* ASTNEWCONSTZ( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	struct $8FBSYMBOL* FLD$1;
	{
		...
		label$54:;
		{
			struct $7ASTNODE* vr$3 = ASTNEWCONSTSTR( (char*)0ull );
			fb$result$1 = vr$3;
		}
		goto label$51;
		label$55:;
		...
		label$59:;
		{
			...
			goto label$65;
			label$62:;
			TMP$90$3 = DTYPE$1 & 31ll;
			label$65:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$90$3 * 56ll)) != 1ll) goto label$64;
			{
		...
		if( TMP$89$2 > 20ull ) goto label$59;
		goto *tmp$91[TMP$89$2 - 0ull];
		label$51:;
	}
	label$50:;
	return fb$result$1;
...
struct $6IRVREG* ASTLOADCONST( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll) goto label$69;
	{
		...
		label$73:;
		if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$92$2 * 56ll)) != 1ll) goto label$72;
		{
			struct $6IRVREG* vr$8 = (*(tmp$72*)((uint8*)&IR$ + 464ll))( DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(double*)((uint8*)N$1 + 40ll) );
			fb$result$1 = vr$8;
		}
		goto label$71;
		label$72:;
		{
			struct $6IRVREG* vr$11 = (*(tmp$71*)((uint8*)&IR$ + 456ll))( DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(int64*)((uint8*)N$1 + 40ll) );
			fb$result$1 = vr$11;
		}
		label$71:;
	}
...
FBSTRING* ASTCONSTFLUSHTOSTR( struct $7ASTNODE* N$1 )
{
	...
	label$86:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$93$1 * 56ll)) != 1ll) goto label$80;
	{
	...
	label$87:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$94$1 * 56ll)) + 16ll) == 0ll) goto label$84;
	{
...
uint32* ASTCONSTFLUSHTOWSTR( struct $7ASTNODE* N$1 )
{
	...
	goto label$98;
	label$90:;
	TMP$95$1 = *(int64*)((uint8*)N$1 + 8ll) & 31ll;
	label$98:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$95$1 * 56ll)) != 1ll) goto label$92;
	{
		if( (*(int64*)((uint8*)N$1 + 8ll) & 511ll) != 16ll) goto label$94;
		{
			...
			TMP$96$3 = vr$9;
			fb_WstrAssign( (uint32*)W$1, 65ll, (uint32*)TMP$96$3 );
			fb_WstrDelete( (uint32*)TMP$96$3 );
		}
		goto label$93;
		label$94:;
		{
			...
			TMP$97$3 = vr$12;
			fb_WstrAssign( (uint32*)W$1, 65ll, (uint32*)TMP$97$3 );
			fb_WstrDelete( (uint32*)TMP$97$3 );
		}
		label$93:;
	}
	goto label$91;
	...
	label$99:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$99$1 * 56ll)) + 16ll) == 0ll) goto label$96;
	{
		uint32* TMP$100$2;
		uint32* vr$24 = fb_LongintToWstr( *(int64*)((uint8*)N$1 + 40ll) );
		TMP$100$2 = vr$24;
		fb_WstrAssign( (uint32*)W$1, 65ll, (uint32*)TMP$100$2 );
		fb_WstrDelete( (uint32*)TMP$100$2 );
	}
	goto label$91;
	label$96:;
	{
		...
		TMP$101$2 = vr$26;
		fb_WstrAssign( (uint32*)W$1, 65ll, (uint32*)TMP$101$2 );
		fb_WstrDelete( (uint32*)TMP$101$2 );
	}
	label$91:;
	ASTDELNODE( N$1 );
...
int64 ASTCONSTGETASINT64( struct $7ASTNODE* N$1 )
{
	...
	label$105:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$102$1 * 56ll)) != 1ll) goto label$104;
	{
...
double ASTCONSTGETASDOUBLE( struct $7ASTNODE* N$1 )
{
	...
	goto label$113;
	label$108:;
	TMP$103$1 = *(int64*)((uint8*)N$1 + 8ll) & 31ll;
	label$113:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$103$1 * 56ll)) != 1ll) goto label$110;
	{
	...
	goto label$114;
	label$112:;
	TMP$104$1 = *(int64*)((uint8*)N$1 + 8ll) & 31ll;
	label$114:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$104$1 * 56ll)) + 16ll) == 0ll) goto label$111;
	{
...
struct $7ASTNODE* ASTBUILDCONST( struct $8FBSYMBOL* SYM$1 )
{
	...
	{
		int64 TMP$105$2;
		TMP$105$2 = DTYPE$1 & 511ll;
		if( TMP$105$2 == 4ll) goto label$119;
		label$120:;
		if( TMP$105$2 != 7ll) goto label$118;
		label$119:;
		{
...
struct $7ASTNODE* ASTCONVERTRAWCONSTI( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	goto label$126;
	label$124:;
	TMP$106$1 = *(int64*)((uint8*)L$1 + 8ll) & 31ll;
	label$126:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$106$1 * 56ll)) + 16ll) == 0ll) goto label$125;
	TMP$107$1 = 13ll;
	goto label$127;
	label$125:;
	TMP$107$1 = 14ll;
	label$127:;
	*(int64*)((uint8*)L$1 + 8ll) = TMP$107$1;
