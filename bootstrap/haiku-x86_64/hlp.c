...
char* HHEXUINT( uint64 VALUE$1 )
{
	...
	static struct $8FBARRAY1IlE tmp$94$1 = { (int64*)HEXTB$1, (int64*)HEXTB$1, 128ll, 8ll, 1ll, 49ll, { { 16ll, 0ll, 15ll } } };
	MAXLEN$1 = 4ll;
...
FBSTRING* HFLOATTOHEX( double VALUE$1, int64 DTYPE$1 )
{
	...
	label$24:;
	if( TMP$109$1 != 16ll) goto label$23;
	{
...
FBSTRING* HFLOATTOHEX_C99( double VALUE$1 )
{
	...
	FBSTRING* vr$37 = fb_StrConcat( &TMP$117$1, (void*)TMP$116$1, 0ll, (void*)vr$34, -1ll );
	__builtin_memset( &TMP$118$1, 0, 24ll );
	FBSTRING* vr$40 = fb_StrConcat( &TMP$118$1, (void*)"p", 2ll, (void*)vr$37, -1ll );
	__builtin_memset( &TMP$119$1, 0, 24ll );
	FBSTRING* vr$44 = fb_StrConcat( &TMP$119$1, (void*)&RET$1, -1ll, (void*)vr$40, -1ll );
...
int64 HFBRELOP2IRRELOP( int64 TK$1 )
{
	...
	static int64 OP$1;
	{
		...
		if( (TMP$120$2 - 299ull) > 5ull ) goto label$49;
		goto *tmp$121[TMP$120$2 - 299ull];
		label$41:;
	}
	fb$result$1 = OP$1;
	label$40:;
...
int64 HFILEEXISTS( char* FILENAME$1 )
{
	...
	if( (int64)vr$5 != 0ll) goto label$53;
	{
		...
		void* vr$10 = fb_ErrorThrowAt( 161, (char*)"src/compiler/hlp.bas", (void*)0ull, (void*)0ull );
		goto *vr$10;
		label$54:;
	}
	goto label$52;
	...
	{
		{
			...
			goto label$70;
			label$71:;
			static const void* tmp$124[123ll] = {
				&&label$72,
				&&label$74,
				&&label$74,
				&&label$74,
			...
			if( TMP$123$3 > 122ull ) goto label$74;
			goto *tmp$124[TMP$123$3 - 0ull];
			label$70:;
		}
		P$1 = (char*)((uint8*)P$1 + 1ll);
	}
...
FBSTRING* HSTRIPFILENAME( char* FILENAME$1 )
{
	...
	static int64 P_FOUND$1;
	static int64 P$1[2];
	static struct $8FBARRAY1IlE tmp$128$1 = { (int64*)((uint8*)P$1 + -8ll), (int64*)P$1, 16ll, 8ll, 1ll, 49ll, { { 2ll, 1ll, 2ll } } };
	LP$1 = 0ll;
	label$101:;
	{
		FBSTRING* vr$1 = fb_StrAllocTempDescZEx( (char*)"\x5C", 1ll );
...
void HREPLACESLASH( char* S$1, int64 CHAR$1 )
{
	label$124:;
	{
		...
		I$2 = I$2 + 1ll;
		label$126:;
		if( I$2 <= TMP$129$2) goto label$129;
		label$128:;
	}
	label$125:;
}
...
FBSTRING* PATHSTRIPDIV( FBSTRING* PATH$1 )
{
	...
	if( LENGTH$1 <= 0ll) goto label$135;
	{
		...
		{
			uint8 TMP$130$3;
			TMP$130$3 = *(uint8*)((uint8*)*(char**)PATH$1 + LENGTH$1);
			if( (uint64)(int64)TMP$130$3 != 47ull) goto label$137;
			label$138:;
			{
...
int64 HCHECKFILEFORMAT( int64 F$1 )
{
	...
	if( (int64)vr$5 != 0ll) goto label$144;
	{
		...
		label$147:;
		{
			BOM$1 = (uint32)((int64)BOM$1 & 16777215ll);
			...
			label$149:;
			{
				BOM$1 = (uint32)((int64)BOM$1 & 65535ll);
		...
		label$145:;
		{
			...
			label$155:;
			{
				...
				void* vr$21 = fb_ErrorThrowAt( 425, (char*)"src/compiler/hlp.bas", (void*)0ull, (void*)0ull );
				goto *vr$21;
				label$156:;
			}
			goto label$153;
			...
			label$158:;
			{
				...
				void* vr$25 = fb_ErrorThrowAt( 428, (char*)"src/compiler/hlp.bas", (void*)0ull, (void*)0ull );
				goto *vr$25;
				label$159:;
			}
			goto label$153;
			...
			label$161:;
			{
				...
				void* vr$29 = fb_ErrorThrowAt( 432, (char*)"src/compiler/hlp.bas", (void*)0ull, (void*)0ull );
				goto *vr$29;
				label$163:;
			}
			label$160:;
...
FBSTRING* HCURDIR( void )
{
	...
	fb_StrAssign( (void*)&TMP$131$1, -1ll, (void*)vr$2, -1ll, 0 );
	FBSTRING* vr$5 = PATHSTRIPDIV( &TMP$131$1 );
	fb_StrAssign( (void*)&fb$result$1, -1ll, (void*)vr$5, -1ll, 0 );
	fb_StrDelete( (FBSTRING*)&TMP$131$1 );
	label$165:;
...
FBSTRING* PATHSTRIPCURDIR( FBSTRING* PATH$1 )
{
	...
	FBSTRING* vr$4 = fb_StrConcat( &TMP$132$1, (void*)vr$1, -1ll, (void*)"/", 2ll );
...
int64 HISVALIDSYMBOLNAME( char* SYM$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$170:;
	if( SYM$1 != (char*)0ull) goto label$173;
	{
		goto label$171;
		label$173:;
	}
	...
	if( (uint64)(int64)(uint8)*SYM$1 < 97ull) goto label$176;
	TMP$135$1 = (int64)-((uint64)(int64)(uint8)*SYM$1 <= 122ull);
	goto label$194;
	label$176:;
	TMP$135$1 = 0ll;
	label$194:;
	if( TMP$135$1 != 0ll) goto label$178;
	if( (uint64)(int64)(uint8)*SYM$1 > 90ull) goto label$177;
	TMP$137$1 = (int64)-((uint64)(int64)(uint8)*SYM$1 >= 65ull);
	goto label$196;
	label$177:;
	TMP$137$1 = 0ll;
	label$196:;
	TMP$138$1 = (int64)-(TMP$137$1 != 0ll);
	goto label$195;
	label$178:;
	TMP$138$1 = -1ll;
	label$195:;
	if( TMP$138$1 != 0ll) goto label$179;
	TMP$140$1 = (int64)-((uint64)(int64)(uint8)*SYM$1 == 95ull);
	goto label$197;
	label$179:;
	TMP$140$1 = -1ll;
	label$197:;
	if( TMP$140$1 != 0ll) goto label$181;
	{
		goto label$171;
		label$181:;
	}
	{
		...
		label$185:;
		{
			...
			int64 TMP$146$3;
			int64 TMP$147$3;
			if( (uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) < 97ull) goto label$186;
			TMP$142$3 = (int64)-((uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) <= 122ull);
			goto label$198;
			label$186:;
			TMP$142$3 = 0ll;
			label$198:;
			if( TMP$142$3 != 0ll) goto label$188;
			if( (uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) > 90ull) goto label$187;
			TMP$143$3 = (int64)-((uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) >= 65ull);
			goto label$200;
			label$187:;
			TMP$143$3 = 0ll;
			label$200:;
			...
			TMP$144$3 = -1ll;
			label$199:;
			if( TMP$144$3 != 0ll) goto label$189;
			TMP$145$3 = (int64)-((uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) == 95ull);
			goto label$201;
			label$189:;
			TMP$145$3 = -1ll;
			label$201:;
			if( TMP$145$3 != 0ll) goto label$191;
			if( (uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) > 57ull) goto label$190;
			TMP$146$3 = (int64)-((uint64)(int64)(uint8)*(char*)((uint8*)SYM$1 + I$2) >= 48ull);
			goto label$203;
			label$190:;
			TMP$146$3 = 0ll;
			label$203:;
			TMP$147$3 = (int64)-(TMP$146$3 != 0ll);
			goto label$202;
			label$191:;
			TMP$147$3 = -1ll;
			label$202:;
			if( TMP$147$3 != 0ll) goto label$193;
			{
				goto label$171;
				label$193:;
			}
		...
		I$2 = I$2 + 1ll;
		label$182:;
		if( I$2 <= TMP$141$2) goto label$185;
		label$184:;
	}
	fb$result$1 = -1ll;
	label$171:;
...
static int64 HFINDEXTBEGIN( FBSTRING* PATH$1 )
{
	...
	label$75:;
	{
		...
		label$80:;
		{
			{
				uint8 TMP$125$4;
				TMP$125$4 = *(uint8*)((uint8*)*(char**)PATH$1 + I$2);
				if( (uint64)(int64)TMP$125$4 != 46ull) goto label$82;
				label$83:;
				{
					fb$result$1 = I$2;
					goto label$76;
				...
				goto label$81;
				label$82:;
				if( (uint64)(int64)TMP$125$4 != 47ull) goto label$84;
				label$85:;
				{
					goto label$79;
				}
