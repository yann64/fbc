...
struct $7ASTNODE* ASTNEWVAR( struct $8FBSYMBOL* SYM$1, int64 OFS$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	{
		{
			$12FB_SYMBCLASS TMP$85$3;
			TMP$85$3 = *($12FB_SYMBCLASS*)SYM$1;
			if( TMP$85$3 != 7ll) goto label$15;
			label$16:;
			{
				DTYPE$1 = 0ll;
...
struct $6IRVREG* ASTLOADVAR( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$10 = (*(tmp$73*)((uint8*)&IR$ + 472ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), S$1, OFS$1 );
		VR$1 = vr$10;
