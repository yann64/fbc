...
typedef struct $6IRVREG* (*tmp$85)( struct $7ASTNODE* );
...
static tmp$85 AST_LOADCALLBACKS$[45] = { (tmp$85)&ASTLOADNOP, (tmp$85)&ASTLOADLOAD, (tmp$85)&ASTLOADASSIGN, (tmp$85)&ASTLOADBOP, (tmp$85)&ASTLOADUOP, (tmp$85)&ASTLOADCONV, (tmp$85)&ASTLOADADDROF, (tmp$85)&ASTLOADBRANCH, (tmp$85)&ASTLOADJMPTB, (tmp$85)&ASTLOADCALL, (tmp$85)&ASTLOADCALLCTOR, (tmp$85)&ASTLOADSTACK, (tmp$85)&ASTLOADMEM, (tmp$85)&ASTLOADLOOP, (tmp$85)0ull, (tmp$85)&ASTLOADLINK, (tmp$85)&ASTLOADCONST, (tmp$85)&ASTLOADVAR, (tmp$85)&ASTLOADIDX, (tmp$85)&ASTLOADFIELD, (tmp$85)&ASTLOADDEREF, (tmp$85)&ASTLOADLABEL, (tmp$85)0ull, (tmp$85)&ASTLOADOFFSET, (tmp$85)&ASTLOADDECL, (tmp$85)&ASTLOADNIDXARRAY, (tmp$85)&ASTLOADIIF, (tmp$85)&ASTLOADLIT, (tmp$85)&ASTLOADASM, (tmp$85)0ull, (tmp$85)&ASTLOADDBG, (tmp$85)&ASTLOADBOUNDCHK, (tmp$85)&ASTLOADPTRCHK, (tmp$85)&ASTLOADSCOPEBEGIN, (tmp$85)&ASTLOADSCOPEEND, (tmp$85)0ull, (tmp$85)0ull, (tmp$85)0ull, (tmp$85)0ull, (tmp$85)0ull, (tmp$85)0ull, (tmp$85)0ull, (tmp$85)0ull, (tmp$85)0ull, (tmp$85)&ASTLOADMACRO };
struct $6ASTCTX AST$;
struct $10AST_OPINFO AST_OPTB$[122] = { { 2ll, 5ll, (char*)"let" }, { 3ll, 5ll, (char*)"+=", 28ll }, { 3ll, 5ll, (char*)"-=", 29ll }, { 3ll, 5ll, (char*)"*=", 30ll }, { 3ll, 5ll, (char*)"/=", 31ll }, { 3ll, 5ll, (char*)"/=", 32ll }, { 3ll, 5ll, (char*)"mod=", 33ll }, { 3ll, 5ll, (char*)"and=", 34ll }, { 3ll, 5ll, (char*)"or=", 35ll }, { 3ll, 5ll, (char*)"andalso=", 36ll }, { 3ll, 5ll, (char*)"orelse=", 37ll }, { 3ll, 5ll, (char*)"xor=", 38ll }, { 3ll, 5ll, (char*)"eqv=", 39ll }, { 3ll, 5ll, (char*)"imp=", 40ll }, { 3ll, 5ll, (char*)"shl=", 41ll }, { 3ll, 5ll, (char*)"shr=", 42ll }, { 3ll, 5ll, (char*)"pow=", 43ll }, { 3ll, 5ll, (char*)"&=", 44ll }, { 12ll, 1ll, (char*)"new" }, { 12ll, 1ll, (char*)"new[]" }, { 12ll, 5ll, (char*)"delete" }, { 12ll, 5ll, (char*)"delete[]" }, { 6ll, 1ll, (char*)"@" }, { 3ll, 1ll, (char*)"[]" }, { 14ll, 5ll, (char*)"for" }, { 14ll, 5ll, (char*)"step" }, { 14ll, 1ll, (char*)"next" }, { 5ll, 1ll, (char*)"cast" }, { 3ll, 2ll, (char*)"+", 1ll }, { 3ll, 0ll, (char*)"-", 2ll }, { 3ll, 2ll, (char*)"*", 3ll }, { 3ll, 0ll, (char*)"/", 4ll }, { 3ll, 0ll, (char*)"/", 5ll }, { 3ll, 0ll, (char*)"mod", 6ll }, { 3ll, 2ll, (char*)"and", 7ll }, { 3ll, 2ll, (char*)"or", 8ll }, { 3ll, 2ll, (char*)"andalso", 9ll }, { 3ll, 2ll, (char*)"orelse", 10ll }, { 3ll, 2ll, (char*)"xor", 11ll }, { 3ll, 0ll, (char*)"eqv", 12ll }, { 3ll, 0ll, (char*)"imp", 13ll }, { 3ll, 0ll, (char*)"shl", 14ll }, { 3ll, 0ll, (char*)"shr", 15ll }, { 3ll, 0ll, (char*)"pow", 16ll }, { 3ll, 0ll, (char*)"&", 17ll }, { 14ll, 10ll, (char*)"=" }, { 14ll, 8ll, (char*)">" }, { 14ll, 8ll, (char*)"<" }, { 14ll, 10ll, (char*)"<>" }, { 14ll, 8ll, (char*)">=" }, { 14ll, 8ll, (char*)"<=" }, { 14ll, 0ll, (char*)"is" }, { 4ll, 0ll, (char*)"not" }, { 4ll, 0ll, (char*)"boolnot" }, { 4ll, 0ll, (char*)"+" }, { 4ll, 0ll, (char*)"-" }, { 4ll, 0ll, (char*)"HADD" }, { 4ll, 0ll, (char*)"abs" }, { 4ll, 0ll, (char*)"sgn" }, { 4ll, 0ll, (char*)"sin" }, { 4ll, 0ll, (char*)"asin" }, { 4ll, 0ll, (char*)"cos" }, { 4ll, 0ll, (char*)"acos" }, { 4ll, 0ll, (char*)"tan" }, { 4ll, 0ll, (char*)"atan" }, { 3ll, 0ll, (char*)"atn2" }, { 4ll, 0ll, (char*)"sqr" }, { 4ll, 0ll, (char*)"rsqrt" }, { 4ll, 0ll, (char*)"rcp" }, { 4ll, 0ll, (char*)"log" }, { 4ll, 0ll, (char*)"exp" }, { 4ll, 0ll, (char*)"int" }, { 4ll, 0ll, (char*)"fix" }, { 4ll, 0ll, (char*)"frac" }, { 4ll, 0ll, (char*)"len" }, { 4ll, 0ll, (char*)"convd2s" }, { 4ll, 0ll, (char*)"swzrep" }, { 6ll, 0ll, (char*)"*" }, { 6ll, 0ll, (char*)"->" }, { 12ll, 0ll, (char*)"new", 18ll }, { 12ll, 0ll, (char*)"new[]", 19ll }, { 12ll, 0ll, (char*)"delete", 20ll }, { 12ll, 0ll, (char*)"delete[]", 21ll }, { 5ll, 0ll, (char*)"cint" }, { 5ll, 0ll, (char*)"cflt" }, { 5ll, 0ll, (char*)"cbool" }, { 1ll, 0ll, (char*)"load" }, { 1ll, 0ll, (char*)"lres" }, { 2ll, 0ll, (char*)"spill" }, { 11ll, 0ll, (char*)"push" }, { 11ll, 0ll, (char*)"pop" }, { 11ll, 0ll, (char*)"pudt" }, { 11ll, 0ll, (char*)"stka" }, { 7ll, 0ll, (char*)"jeq" }, { 7ll, 0ll, (char*)"jgt" }, { 7ll, 0ll, (char*)"jlt" }, { 7ll, 0ll, (char*)"jne" }, { 7ll, 0ll, (char*)"jge" }, { 7ll, 0ll, (char*)"jle" }, { 7ll, 0ll, (char*)"jmp" }, { 7ll, 0ll, (char*)"call" }, { 7ll, 0ll, (char*)"lbl" }, { 7ll, 0ll, (char*)"ret" }, { 9ll, 0ll, (char*)"calf" }, { 9ll, 0ll, (char*)"calp" }, { 9ll, 0ll, (char*)"jmpp" }, { 12ll, 0ll, (char*)"mmov" }, { 12ll, 0ll, (char*)"mswp" }, { 12ll, 0ll, (char*)"mfill" }, { 12ll, 0ll, (char*)"stkc" }, { 44ll, 0ll, (char*)"va_start" }, { 44ll, 0ll, (char*)"va_end" }, { 44ll, 0ll, (char*)"va_copy" }, { 44ll, 0ll, (char*)"va_arg" }, { 30ll, 0ll, (char*)"lini" }, { 30ll, 0ll, (char*)"lend" }, { 30ll, 0ll, (char*)"sini" }, { 30ll, 0ll, (char*)"send" }, { 27ll, 0ll, (char*)"rem" }, { 27ll, 0ll, (char*)"asm" } };
...
struct $7ASTNODE* ASTCLONETREE( struct $7ASTNODE* N$1 )
{
	...
	label$20:;
	{
		$13AST_NODECLASS TMP$197$2;
		TMP$197$2 = *($13AST_NODECLASS*)N$1;
		if( TMP$197$2 != 17ll) goto label$23;
		label$24:;
		{
		...
		goto label$22;
		label$23:;
		if( TMP$197$2 != 9ll) goto label$29;
		label$30:;
		{
		...
		goto label$22;
		label$29:;
		if( TMP$197$2 != 26ll) goto label$31;
		label$32:;
		{
			struct $8FBSYMBOL* vr$19 = SYMBADDLABEL( (char*)0ull, 4ll );
			ASTREPLACESYMBOLONTREE( C$1, *(struct $8FBSYMBOL**)((uint8*)C$1 + 40ll), vr$19 );
		}
		goto label$22;
		label$31:;
		if( TMP$197$2 != 13ll) goto label$33;
		label$34:;
		{
			struct $8FBSYMBOL* vr$21 = SYMBADDLABEL( (char*)0ull, 4ll );
			ASTREPLACESYMBOLONTREE( C$1, *(struct $8FBSYMBOL**)((uint8*)C$1 + 56ll), vr$21 );
		}
		goto label$22;
		label$33:;
		if( TMP$197$2 != 36ll) goto label$35;
		label$36:;
		{
		...
		goto label$22;
		label$35:;
		if( TMP$197$2 != 19ll) goto label$37;
		label$38:;
		{
	...
	{
		{
			...
			if( TMP$198$3 != 1ll) goto label$46;
			label$47:;
			{
			...
			goto label$45;
			label$46:;
			if( TMP$198$3 != 2ll) goto label$48;
			label$49:;
			{
...
struct $7ASTNODE* ASTREBUILDWITHOUTEFFECTIVEPART( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)N$1 != 15ll) goto label$56;
	{
		...
		{
			int64 TMP$199$3;
			TMP$199$3 = *(int64*)((uint8*)N$1 + 40ll);
			if( TMP$199$3 != 1ll) goto label$58;
			label$59:;
			{
			...
			goto label$57;
			label$58:;
			if( TMP$199$3 != 2ll) goto label$60;
			label$61:;
			{
...
int64 ASTCANTAKEADDROF( struct $7ASTNODE* N$1 )
{
	...
	label$63:;
	{
		...
		label$69:;
		{
			{
				int64 TMP$201$4;
				TMP$201$4 = *(int64*)((uint8*)N$1 + 40ll);
				if( TMP$201$4 != 1ll) goto label$71;
				label$72:;
				{
				...
				goto label$70;
				label$71:;
				if( TMP$201$4 != 2ll) goto label$73;
				label$74:;
				{
		...
		goto label$65;
		label$66:;
		static const void* tmp$202[27ll] = {
			&&label$67,
			&&label$76,
			&&label$76,
			&&label$76,
		...
		if( (TMP$200$2 - 10ull) > 26ull ) goto label$76;
		goto *tmp$202[TMP$200$2 - 10ull];
		label$65:;
	}
	label$64:;
	return fb$result$1;
...
struct $7ASTNODE* ASTMAKEREF( struct $7ASTNODE** EXPR$1 )
{
	...
	TMP$203$1 = (int64)-(*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)*EXPR$1 + 24ll) + 192ll) > 0ll);
	goto label$88;
	label$79:;
	TMP$203$1 = 0ll;
	label$88:;
	if( TMP$203$1 == 0ll) goto label$81;
	{
	...
	if( *(int64*)*EXPR$1 != 9ll) goto label$83;
	{
		{
			int64 TMP$204$3;
			TMP$204$3 = *(int64*)((uint8*)*EXPR$1 + 8ll) & 511ll;
			if( TMP$204$3 == 17ll) goto label$86;
			label$87:;
			if( TMP$204$3 != 7ll) goto label$85;
			label$86:;
			{
...
struct $7ASTNODE* ASTREMSIDEFX( struct $7ASTNODE** N$1 )
{
	...
	*N$1 = vr$2;
	{
		uint64 TMP$205$2;
		TMP$205$2 = (uint64)(*(int64*)((uint8*)*N$1 + 8ll) & 511ll);
		goto label$92;
		label$93:;
		{
		...
		if( (TMP$205$2 - 4ull) > 16ull ) goto label$94;
		goto *tmp$206[TMP$205$2 - 4ull];
		label$91:;
	}
	label$90:;
	return fb$result$1;
...
int64 ASTGETINVERSELOGOP( int64 OP$1 )
{
	...
	label$117:;
	{
		...
		if( (TMP$207$2 - 45ull) > 5ull ) goto label$119;
		goto *tmp$208[TMP$207$2 - 45ull];
		label$119:;
	}
	fb$result$1 = OP$1;
	label$118:;
...
struct $6IRVREG* ASTLOAD( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$1 = (*(tmp$85*)((int64)(tmp$85*)AST_LOADCALLBACKS$ + (*(int64*)N$1 << (3ll & 63ll))))( N$1 );
		fb$result$1 = vr$1;
	}
	label$130:;
	label$129:;
