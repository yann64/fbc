...
struct $7ASTNODE* ASTNEWMACRO( $6AST_OP OP$1, struct $7ASTNODE* ARG1$1, struct $7ASTNODE* ARG2$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) = *(struct $8FBSYMBOL**)((uint8*)ARG1$1 + 24ll);
	if( OP$1 != 113ll) goto label$13;
	{
		{
			int64 TMP$85$3;
			$12FB_DATACLASS TMP$86$3;
			if( (DTYPE$1 & 480ll) == 0ll) goto label$14;
			TMP$85$3 = 24ll;
			goto label$26;
			label$14:;
			TMP$85$3 = DTYPE$1 & 31ll;
			label$26:;
			TMP$86$3 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$85$3 * 56ll));
			if( TMP$86$3 != 0ll) goto label$16;
			label$17:;
			{
				int64 TMP$87$4;
				...
				label$27:;
				if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$87$4 * 56ll)) + 8ll) >= *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll)) goto label$20;
				{
			...
			label$22:;
			{
				...
				goto label$28;
				label$23:;
				TMP$88$4 = DTYPE$1 & 31ll;
				label$28:;
				if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$88$4 * 56ll)) + 8ll) >= *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 904ll)) goto label$25;
				{
...
struct $6IRVREG* ASTLOADMACRO( struct $7ASTNODE* N$1 )
{
	...
	OP$1 = *($6AST_OP*)((uint8*)N$1 + 40ll);
	{
		...
		label$37:;
		{
			...
			V2$1 = vr$12;
			struct $6IRVREG* vr$15 = (*(tmp$70*)((uint8*)&IR$ + 448ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) );
			VR$1 = vr$15;
		}
		goto label$31;
		label$36:;
		if( OP$1 != 112ll) goto label$38;
		label$39:;
		{
	...
	{
		(*(tmp$60*)((uint8*)&IR$ + 304ll))( OP$1, V1$1, V2$1, VR$1 );
	}
	label$41:;
	label$40:;
