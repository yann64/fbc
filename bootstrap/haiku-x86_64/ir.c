...
void IRINIT( void )
{
	label$10:;
	{
		$10FB_BACKEND TMP$107$2;
		TMP$107$2 = *($10FB_BACKEND*)((uint8*)&ENV$ + 208ll);
		if( TMP$107$2 == 1ll) goto label$14;
		label$15:;
		if( TMP$107$2 != 2ll) goto label$13;
		label$14:;
		{
		...
		goto label$12;
		label$13:;
		if( TMP$107$2 != 3ll) goto label$16;
		label$17:;
		{
		...
		goto label$12;
		label$16:;
		if( TMP$107$2 != 4ll) goto label$18;
		label$19:;
		{
...
void IRFOREACHDATASTMT( tmp$43 CALLBACK$1 )
{
	label$51:;
...
{
	label$55:;
	if( (*(int64*)((uint8*)SYM$1 + 24ll) & 268435456ll) != 0ll) goto label$58;
	{
