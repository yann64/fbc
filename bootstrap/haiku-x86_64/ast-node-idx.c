	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll) goto label$19;
	{
		...
		*($12FB_SYMBSTATS*)((uint8*)S$1 + 24ll) = *(int64*)((uint8*)S$1 + 24ll) | 2ll;
		...
		if( VIDX$1 == (struct $6IRVREG*)0ull) goto label$23;
		{
			...
			{
				(*(tmp$54*)((uint8*)&IR$ + 216ll))( VIDX$1 );
			}
			label$25:;
			label$24:;
			struct $6IRVREG* vr$21 = (*(tmp$74*)((uint8*)&IR$ + 480ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), S$1, OFS$1, *(int64*)((uint8*)N$1 + 48ll), VIDX$1 );
			VR$1 = vr$21;
		}
		goto label$22;
		label$23:;
		{
			struct $6IRVREG* vr$24 = (*(tmp$73*)((uint8*)&IR$ + 472ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), S$1, OFS$1 );
			VR$1 = vr$24;
		}
		label$22:;
