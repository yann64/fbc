...
int32 main( int32 __FB_ARGC__$0, char** __FB_ARGV__$0 )
{
	...
	label$1571:;
	{
		...
		fb_StrAssign( (void*)&TMP$875$1, -1ll, (void*)((uint8*)&FBC$ + 3298ll), 261ll, 0 );
		FBADDINCLUDEPATH( &TMP$875$1 );
		fb_StrAssign( (void*)((uint8*)&FBC$ + 3298ll), 261ll, (void*)&TMP$875$1, -1ll, 0 );
		fb_StrDelete( (FBSTRING*)&TMP$875$1 );
		...
		if( *(int64*)((uint8*)&FBC$ + 136ll) < 0ll) goto label$1577;
		{
			{
				int64 TMP$876$3;
				TMP$876$3 = *(int64*)((uint8*)&FBC$ + 136ll);
				if( TMP$876$3 != 0ll) goto label$1579;
				label$1580:;
				{
				...
				goto label$1578;
				label$1579:;
				if( TMP$876$3 != 1ll) goto label$1581;
				label$1582:;
				{
				...
				goto label$1578;
				label$1581:;
				if( TMP$876$3 != 2ll) goto label$1583;
				label$1584:;
				{
				...
				goto label$1578;
				label$1583:;
				if( TMP$876$3 != 3ll) goto label$1587;
				label$1588:;
				{
				...
				goto label$1578;
				label$1587:;
				if( TMP$876$3 != 4ll) goto label$1589;
				label$1590:;
				{
				...
				goto label$1578;
				label$1589:;
				if( TMP$876$3 != 5ll) goto label$1591;
				label$1592:;
				{
...
static int64 HLINKFILES( void )
{
	...
	label$269:;
	{
		...
		goto label$277;
		label$278:;
		static const void* tmp$879[14ll] = {
			&&label$279,
			&&label$279,
			&&label$295,
			&&label$295,
	...
	label$358:;
	{
				...
				{
					{
						...
						goto label$383;
						label$384:;
						static const void* tmp$881[3ll] = {
							&&label$385,
							&&label$386,
							&&label$385,
						};
						if( (TMP$246$6 - 9ull) > 2ull ) goto label$386;
						goto *tmp$881[TMP$246$6 - 9ull];
						label$383:;
					}
				}
				goto label$381;
				...
				{
					{
						...
						goto label$387;
						label$388:;
						static const void* tmp$882[3ll] = {
							&&label$389,
							&&label$390,
							&&label$389,
						};
						if( (TMP$248$6 - 9ull) > 2ull ) goto label$390;
						goto *tmp$882[TMP$248$6 - 9ull];
						label$387:;
					}
				}
				label$381:;
		...
		goto label$360;
		label$361:;
		static const void* tmp$883[14ll] = {
			&&label$367,
			&&label$362,
			&&label$378,
			&&label$397,
	...
	label$432:;
	{
		...
		goto label$436;
		label$437:;
		static const void* tmp$884[14ll] = {
			&&label$446,
			&&label$436,
			&&label$438,
			&&label$443,
	...
	label$447:;
	{
		...
		goto label$449;
		label$450:;
		static const void* tmp$885[12ll] = {
			&&label$451,
			&&label$449,
			&&label$449,
			&&label$449,
...
static void HANDLEOPT( int64 OPTID$1, FBSTRING* ARG$1, int64 IS_SOURCE$1 )
{
	label$569:;
	{
		...
		goto label$571;
		label$572:;
		static const void* tmp$888[74ll] = {
			&&label$573,
			&&label$574,
			&&label$577,
			&&label$584,
...
static int64 PARSEOPTION( char* OPT$1 )
{
	...
	label$803:;
	{
		...
		goto label$805;
		label$806:;
		static const void* tmp$889[78ll] = {
			&&label$980,
			&&label$805,
			&&label$805,
			&&label$805,
...
static void HCHECKARGS( void )
{
	...
	}
	{
		...
		goto label$1125;
		label$1126:;
		static const void* tmp$892[10ll] = {
			&&label$1127,
			&&label$1128,
			&&label$1128,
			&&label$1128,
	...
	label$1268:;
	{
		...
		label$1272:;
		{
			...
			fb_StrConcatAssign( (void*)&LN$1, -1ll, (void*)"-fno-strict-aliasing ", 22ll, 0 );
			{
				...
				goto label$1304;
				label$1305:;
				static const void* tmp$893[1ll] = {
					&&label$1306,
				};
				if( TMP$629$4 > 0ull ) goto label$1304;
				goto *tmp$893[TMP$629$4 - 0ull];
				label$1304:;
			}
...
static void HADDDEFAULTLIBS( void )
{
	...
	if( vr$15 == 0ll) goto label$1481;
	{
		...
		fb_StrDelete( (FBSTRING*)&TMP$712$2 );
		{
			...
			label$1486:;
			{
				...
				FBCADDDEFLIB( (char*)"GL" );
				FBCADDDEFLIB( (char*)"game" );
			}
			goto label$1482;
			label$1487:;
			{
			...
			goto label$1482;
			label$1483:;
			static const void* tmp$894[14ll] = {
				&&label$1484,
				&&label$1484,
				&&label$1485,
				&&label$1487,
	...
	label$1480:;
	{
		...
		goto label$1488;
		label$1489:;
		static const void* tmp$895[14ll] = {
			&&label$1508,
			&&label$1490,
			&&label$1499,
			&&label$1507,
		...
		if( TMP$725$2 > 13ull ) goto label$1488;
		goto *tmp$895[TMP$725$2 - 0ull];
		label$1488:;
	}
	label$1477:;
}
...
static void HEXCLUDELIBSFROMLINK( void )
{
	...
	if( I$1 == (struct $11TSTRSETITEM*)0ull) goto label$1519;
	{
		{
			FBSTRING TMP$750$3;
			fb_StrInit( (void*)&TMP$750$3, -1ll, (void*)I$1, -1ll, 0 );
			int32 vr$6 = fb_StrCompare( (void*)&TMP$750$3, -1ll, (void*)"fbrt0.o", 8ll );
			if( (int64)vr$6 == 0ll) goto label$1522;
			label$1523:;
			int32 vr$9 = fb_StrCompare( (void*)&TMP$750$3, -1ll, (void*)"fbrt0pic.o", 11ll );
			if( (int64)vr$9 == 0ll) goto label$1522;
			label$1524:;
			int32 vr$12 = fb_StrCompare( (void*)&TMP$750$3, -1ll, (void*)"fbrt1.o", 8ll );
			if( (int64)vr$12 == 0ll) goto label$1522;
			label$1525:;
			int32 vr$15 = fb_StrCompare( (void*)&TMP$750$3, -1ll, (void*)"fbrt1pic.o", 11ll );
			if( (int64)vr$15 == 0ll) goto label$1522;
			label$1526:;
			int32 vr$18 = fb_StrCompare( (void*)&TMP$750$3, -1ll, (void*)"fbrt2.o", 8ll );
			if( (int64)vr$18 == 0ll) goto label$1522;
			label$1527:;
			int32 vr$21 = fb_StrCompare( (void*)&TMP$750$3, -1ll, (void*)"fbrt2pic.o", 11ll );
			...
			label$1528:;
			label$1520:;
			fb_StrDelete( (FBSTRING*)&TMP$750$3 );
		}
...
static void HPRINTVERSION( int64 VERBOSE$1 )
{
	...
	FBSTRING* vr$6 = fb_StrConcat( &TMP$868$1, (void*)"FreeBASIC Compiler - Version 1.20.0 (2026-08-21), built for ", 61ll, (void*)vr$3, -1ll );
	__builtin_memset( &TMP$869$1, 0, 24ll );
	FBSTRING* vr$9 = fb_StrConcat( &TMP$869$1, (void*)vr$6, -1ll, (void*)" (", 3ll );
	__builtin_memset( &TMP$870$1, 0, 24ll );
	FBSTRING* vr$12 = fb_StrConcat( &TMP$870$1, (void*)vr$9, -1ll, (void*)vr$2, -1ll );
	__builtin_memset( &TMP$871$1, 0, 24ll );
	FBSTRING* vr$15 = fb_StrConcat( &TMP$871$1, (void*)vr$12, -1ll, (void*)"bit)", 5ll );
	fb_PrintString( 0, (FBSTRING*)vr$15, 1 );
