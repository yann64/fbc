...
struct $7ASTNODE* CMATHFUNCT( $8FB_TOKEN TK$1, int64 ISASM$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0ull;
	{
		...
		label$87:;
		{
			struct $7ASTNODE* vr$1 = HMATHOP( 57ll );
			fb$result$1 = vr$1;
		}
		goto label$85;
		label$88:;
		{
			struct $7ASTNODE* vr$2 = HMATHOP( 58ll );
			fb$result$1 = vr$2;
		}
		goto label$85;
		label$89:;
		{
			struct $7ASTNODE* vr$3 = HMATHOP( 72ll );
			fb$result$1 = vr$3;
		}
		goto label$85;
		label$90:;
		{
			struct $7ASTNODE* vr$4 = HMATHOP( 73ll );
			fb$result$1 = vr$4;
		}
		goto label$85;
		label$91:;
		{
			struct $7ASTNODE* vr$5 = HMATHOP( 71ll );
			fb$result$1 = vr$5;
		}
		goto label$85;
		label$92:;
		{
			struct $7ASTNODE* vr$6 = HMATHOP( 59ll );
			fb$result$1 = vr$6;
		}
		goto label$85;
		label$93:;
		{
			struct $7ASTNODE* vr$7 = HMATHOP( 60ll );
			fb$result$1 = vr$7;
		}
		goto label$85;
		label$94:;
		{
			struct $7ASTNODE* vr$8 = HMATHOP( 61ll );
			fb$result$1 = vr$8;
		}
		goto label$85;
		label$95:;
		{
			struct $7ASTNODE* vr$9 = HMATHOP( 62ll );
			fb$result$1 = vr$9;
		}
		goto label$85;
		label$96:;
		{
			struct $7ASTNODE* vr$10 = HMATHOP( 63ll );
			fb$result$1 = vr$10;
		}
		goto label$85;
		label$97:;
		{
			struct $7ASTNODE* vr$11 = HMATHOP( 64ll );
			fb$result$1 = vr$11;
		}
		goto label$85;
		label$98:;
		{
			struct $7ASTNODE* vr$12 = HMATHOP( 66ll );
			fb$result$1 = vr$12;
		}
		goto label$85;
		label$99:;
		{
			struct $7ASTNODE* vr$13 = HMATHOP( 69ll );
			fb$result$1 = vr$13;
		}
		goto label$85;
		label$100:;
		{
			struct $7ASTNODE* vr$14 = HMATHOP( 70ll );
			fb$result$1 = vr$14;
		}
		goto label$85;
		label$101:;
		...
		goto label$85;
		label$86:;
		static const void* tmp$107[19ll] = {
			&&label$87,
			&&label$88,
			&&label$89,
			&&label$90,
		...
		if( (TMP$106$2 - 448ull) > 18ull ) goto label$85;
		goto *tmp$107[TMP$106$2 - 448ull];
		label$85:;
	}
	label$84:;
	return fb$result$1;
...
static struct $7ASTNODE* HATAN2( void )
{
	...
	label$30:;
	struct $7ASTNODE* vr$6 = ASTNEWBOP( 65ll, EXPR$1, EXPR2$1, (struct $8FBSYMBOL*)0ull, 1ll );
	EXPR$1 = vr$6;
...
static struct $7ASTNODE* HLEN( struct $7ASTNODE* EXPR$1, int64* LGT$1 )
{
	...
	{
		int64 TMP$96$2;
		TMP$96$2 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
		if( TMP$96$2 != 17ll) goto label$37;
		label$38:;
		{
		...
		label$40:;
		{
			...
			label$42:;
			label$41:;
			int64 vr$6 = SYMBGETSTRLENGTH( LITSYM$1 );
			*LGT$1 = vr$6;
		}
		goto label$36;
		label$39:;
		if( TMP$96$2 != 7ll) goto label$43;
		label$44:;
		{
			int64 TMP$97$3;
			struct $8FBSYMBOL* vr$8 = ASTGETSTRLITSYMBOL( EXPR$1 );
			LITSYM$1 = vr$8;
			if( LITSYM$1 != (struct $8FBSYMBOL*)0ull) goto label$46;
			{
				struct $7ASTNODE* vr$9 = RTLWSTRLEN( EXPR$1 );
				fb$result$1 = vr$9;
				goto label$35;
			}
			label$46:;
			label$45:;
			TMP$97$3 = 0ll;
			uint32* vr$12 = HUNESCAPEW( *(uint32**)((uint8*)LITSYM$1 + 96ll), &TMP$97$3 );
			int64 vr$13 = fb_WstrLen( (uint32*)vr$12 );
			*LGT$1 = vr$13;
		}
		goto label$36;
		label$43:;
		if( TMP$96$2 != 18ll) goto label$47;
		label$48:;
		{
			int64 TMP$98$3;
			TMP$98$3 = 0ll;
			int64 vr$16 = ASTSIZEOF( EXPR$1, &TMP$98$3 );
			*LGT$1 = vr$16;
		}
		goto label$36;
		label$47:;
		if( TMP$96$2 != 20ll) goto label$49;
		label$50:;
		{
			int64 TMP$99$3;
			struct $7ASTNODE* vr$18 = ASTNEWUOP( 74ll, EXPR$1 );
			LENEXPR$1 = vr$18;
			...
			label$51:;
			TMP$99$3 = 0ll;
			int64 vr$20 = ASTSIZEOF( EXPR$1, &TMP$99$3 );
			*LGT$1 = vr$20;
		}
		goto label$36;
		label$49:;
		{
			int64 TMP$100$3;
			TMP$100$3 = 0ll;
			int64 vr$23 = ASTSIZEOF( EXPR$1, &TMP$100$3 );
			*LGT$1 = vr$23;
		}
		label$53:;
		label$36:;
...
static struct $7ASTNODE* HLENSIZEOF( int64 TK$1, int64 ISASM$1 )
{
	...
	label$56:;
	TMP$101$1 = 0ll;
	struct $7ASTNODE* vr$6 = CTYPEOREXPRESSION( TK$1, &DTYPE$1, &SUBTYPE$1, &LGT$1, &TMP$101$1 );
	EXPR$1 = vr$6;
	...
	{
		struct $8FBSYMBOL* TMP$102$2;
		int64 IS_FIXLENSTR$2;
		__builtin_memset( &IS_FIXLENSTR$2, 0, 8ll );
		TMP$102$2 = (struct $8FBSYMBOL*)0ull;
		CUDTTYPEMEMBER( &DTYPE$1, &SUBTYPE$1, &LGT$1, &IS_FIXLENSTR$2, &TMP$102$2 );
	}
	goto label$58;
	label$62:;
	if( TK$1 != 465ll) goto label$63;
	{
		struct $8FBSYMBOL* TMP$103$2;
		int64 IS_FIXLENSTR$2;
		__builtin_memset( &IS_FIXLENSTR$2, 0, 8ll );
		TMP$103$2 = (struct $8FBSYMBOL*)0ull;
		CUDTTYPEMEMBER( &DTYPE$1, &SUBTYPE$1, &LGT$1, &IS_FIXLENSTR$2, &TMP$103$2 );
		if( IS_FIXLENSTR$2 == 0ll) goto label$65;
		{
			{
				int64 TMP$104$4;
				TMP$104$4 = DTYPE$1 & 511ll;
				if( TMP$104$4 == 4ll) goto label$68;
				label$69:;
				if( TMP$104$4 == 17ll) goto label$68;
				label$70:;
				if( TMP$104$4 != 18ll) goto label$67;
				label$68:;
				{
				...
				goto label$66;
				label$67:;
				if( TMP$104$4 != 7ll) goto label$71;
				label$72:;
				{
	...
	if( EXPR$1 == (struct $7ASTNODE*)0ull) goto label$78;
	{
		...
		{
			struct $7ASTNODE* vr$33 = HLEN( EXPR$1, &LGT$1 );
			EXPR$1 = vr$33;
			if( EXPR$1 != (struct $7ASTNODE*)0ull) goto label$82;
			{
				struct $7ASTNODE* vr$34 = ASTNEWCONSTI( LGT$1, 8ll, (struct $8FBSYMBOL*)0ull );
				EXPR$1 = vr$34;
			}
			label$82:;
			label$81:;
		...
		label$80:;
		{
			int64 TMP$105$3;
			TMP$105$3 = 0ll;
			int64 vr$36 = ASTSIZEOF( EXPR$1, &TMP$105$3 );
			LGT$1 = vr$36;
			ASTDELTREE( EXPR$1 );
			struct $7ASTNODE* vr$37 = ASTNEWCONSTI( LGT$1, 8ll, (struct $8FBSYMBOL*)0ull );
			EXPR$1 = vr$37;
		}
		label$79:;
	}
